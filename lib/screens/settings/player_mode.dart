...
import 'package:team_giant_hockey/screens/play_onine/play_online.dart';
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(width: 3, color: data.color),
                              ),
                              child: Center(
                                child: Icon(
                                  data.icon,
              ...
              Padding(
                ...
                child: GestureDetector(
                  onTap: () {
                    ...
                    } else if (playerList[selected].title == 'Play Online') {
                      Get.to(PlayOnline(
                        paddleType: pucks[puckNumber],
                      ));
                    }
